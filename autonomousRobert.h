...
vex::motor LM21 = vex::motor(vex::PORT8, true);

vex::motor RM1 = vex::motor(vex::PORT16, false);
vex::motor RM11 = vex::motor(vex::PORT13, true);

vex::motor RM2 = vex::motor(vex::PORT15, true);
vex::motor RM21 = vex::motor(vex::PORT14, false);
